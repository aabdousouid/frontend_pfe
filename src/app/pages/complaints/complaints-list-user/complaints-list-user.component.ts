...
@Component({
  ...
  styleUrl: './complaints-list-user.component.scss',
  providers: [ConfirmationService, MessageService],
})
export class ComplaintsListUserComponent implements OnInit{
...
statusOptionsForDropdown = [
  ...
  { label: 'Titre', value: 'title' }
   ...
   onComplaintAdded(newComplaint: Complaint) {
  this.complaints.unshift(newComplaint); // Add to the top of the list
  this.applyFilters(); // Re-apply filters
  this.visible = false; // Close the dialog if needed

  this.messageService.add({
    severity: 'success',
    summary: 'Nouvelle réclamation',
    detail: 'La réclamation a été ajoutée avec succès.'
  });
}
 ...
 viewComplaint(complaint: Complaint) {
  ...
  getTypeSeverity(type: ComplaintType): string {
   ...
   loadApplications() {
     ...
     this.complaintService.getComplaintsByUserId(this.user.id).subscribe({
       next: (data) => {
