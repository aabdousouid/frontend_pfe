                ...
                <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                        <div class="text-center mb-8">
                            ...
                            <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">Welcome to ACTIA ES!</div>
                        ...
                        <div>
                            ...
                            <input pInputText id="username" name="username" type="text" placeholder="Username" class="w-full md:w-[30rem] mb-8" [(ngModel)]="form.username" required #username="ngModel" />
                            ...
                            <p-password id="password" [(ngModel)]="form.password" placeholder="Password" name="password" [toggleMask]="true" styleClass="mb-4" [fluid]="true" [feedback]="false" required minlength="6" #password="ngModel"></p-password>
                            ...
                            <p class="block text-surface-900 dark:text-surface-0 text-s font-small mb-1">Or</p>
                            
                            </div>

                            <div class="flex items-center justify-center">
                            <p-button label="Register" severity="success" text (onClick)="navigateToRegister()"></p-button>
                            ...
                            <p-message severity="error">Login Failed : {{errorMessage}}</p-message>
...
<!--       <div class="alert alert-success">Logged in as {{ roles }}.</div>-->          
            <p-message severity="success">Logged in as {{ roles }}.</p-message>
      }
...
export class Login implements OnInit{
    ...
    errorMessage = '';
    roles: string[] = [];
    constructor(private route: ActivatedRoute,private authService: AuthService, private storageService: StorageService,private messageService:MessageService,private router:Router){
