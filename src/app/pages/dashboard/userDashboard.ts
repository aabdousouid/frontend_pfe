...
constructor(private statsService: DashboardstatsService,private storageService:StorageService,private interviewService: InterviewService,private jobService:JobsService) {}


  ngOnInit(): void {
    this.userId = this.storageService.getUser().id;

    this.interviewService.getUserUpcomingInterviews(this.userId).subscribe((data) => {
      this.upcomingInterviews = data;
      this.loadingInterviews = false;
    });


    this.statsService.getUserStats(this.userId).subscribe((stats: DashboardStatsResponse) => {
